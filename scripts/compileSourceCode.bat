...
rem 因为电脑里装了多个版本的jdk，这里为了能正常编译，手动设置了JAVA_HOME
set "JAVA_HOME=D:\worksoft\Java\jdk1.7.0_79"
rem set "JAVA_CMD=%JAVA_HOME%\bin\java"
...
%JAVAC_CMD% -encoding UTF-8 -J-Xms16m -J-Xmx1024m -sourcepath %SOURCE_DIR% -cp rt.jar;tools.jar -d %RT_DEBUG_DIR% -g @filelist.txt >> log.txt 2>&1
